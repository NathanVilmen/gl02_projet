...
question.prototype.tri = function(data){
	...
	console.log("Normalement il y a 1!!!"+numero);
	this.num=numero;
	...
	console.log("Normalement il y a The science of happiness!!!"+titreFinale);
	this.titre=titre;

    //Avoir la localisation
    var localisation=this.triLocalisation(data);
    console.log("Normalement il y a EM U4 p32 Review 1 MultiChoice!!!"+localisation);
    ...
    console.log("Normalement il y a Read the text below and decide which answer best fits each gap. There is an example at the beginning.!!!"+ instructionFinale);
    ...
    console.log("Normalement il y a MultiChoice!!!"+ typeFinale);
    ...
    if(this.type=='Multiple Choice'){
        ...
        console.log("People are attracted to attempting extreme activities for a <insert answer> of reasons"+ phrase1Finale);
